...
def main():
    tasks = [
        ...
        'out'     : 'وپ:گزارش دیتابیس/مقاله‌های دارای پیوند به رایانامه',
        'cols'    : [u'ردیف', u'صفحه'],
        'summary' : u'به روز کردن آمار',
        'pref'    : u'[[رده:گزارش‌های دیتابیس ویکی‌پدیا]]\nاین فهرست مقاله‌هایی را نشان می‌دهد که پیوند به نشانی ایمیل دارند (اما مواردی که نشانی ایمیل مربوط به خود ویکی‌مدیا است را نشان نمی‌دهد).\n\nآخرین به روز رسانی: ~~~~~',
