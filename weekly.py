...
""",
            ...
            "pref": """
[[رده:گزارش‌های دیتابیس ویکی‌پدیا]]
این صفحه تعداد [[ویکی‌پدیا:نظرخواهی برای حذف|نبح‌هایی]] که دربارهٔ هر یک از موضوعات نبح هستند
را نشان می‌دهد.
...
LIMIT 500
""",
            "out": "وپ:گزارش دیتابیس/کاربران ویکی‌پدیا بر پایه تعداد انتقال‌ها",
            "cols": ["ردیف", "کاربر", "تعداد"],
            "summary": "به روز کردن آمار",
            "pref": """
[[رده:گزارش‌های دیتابیس ویکی‌پدیا]]
این صفحه کاربران را بر پایهٔ تعداد انتقال‌هایی که انجام داده‌اند فهرست می‌کند.
نتایج محدود به کاربرانی است که در حال حاضر ربات نیستند، و فقط ۵۰۰ کاربر اول را نشان می‌دهد.
