...
def main(sqlnum):
    tasks = [
        ...
        },
        {
            ...
            "cols": [u'ردیف', u'مقالهٔ ویکی‌پدیای فارسی', u'مقالهٔ ویکی‌پدیای انگلیسی', u'پروندهٔ به کار رفته در ویکی‌پدیای انگلیسی',u'نام پرونده'],
            "summary": u'به روز کردن آمار',
            "pref":
