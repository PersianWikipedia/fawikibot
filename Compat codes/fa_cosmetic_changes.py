...
def dictation(txt,msg_short,msg=msg):
   ...
   #txt = re.sub(u'‌(?=الهام|الصاق|الزام|القا|الکتریک|الکتریسیته)', u'', txt)
    ...
    txt = re.sub(bLB+u'(رهبر|خوب|بد|من)یّ?ت', ur'\1ی', txt) # یّت -> ی
